        ...
        <div class="row justify-content-center text-center pt-3">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="info-box info--box info--box-2 hover-s border-blue">
                    ...
                    <h3 class="info__title font-weight-bold fs-20">{{ $topThree[1]->name }}</h3>
            ...
            <div class="col-lg-4 col-md-6 mb-4" style="margin-top:-20px;">
                <div class="info-box info--box info--box-2 hover-s border-blue">
                    ...
                    <h3 class="info__title font-weight-bold fs-22">{{ $topThree[0]->name }}</h3>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="info-box info--box info--box-2 hover-s border-blue">
                    <img src="{{ !empty($topThree[2]->photo) ? url('upload/user_images/' . $topThree[2]->photo) : url('upload/no_image.jpg') }}"
                        class="rounded-circle" width="80" height="80">
                    <h3 class="info__title font-weight-bold fs-20">{{ $topThree[2]->name }}</h3>
            ...
            <table class="table generic-table">
                ...
                <tbody>
                    ...
                    <tr @if($user->id == auth()->id()) class="table-success" @endif>
                        ...
                        <td class="text-center font-weight-bold text-warning">{{ $user->total_points }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
