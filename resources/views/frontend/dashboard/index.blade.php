...
<div class="container py-4" style="max-width: 1100px; margin-top: -20px;">
    {{-- Profile Header --}}
    <div class="card border-0 shadow-sm p-4 " style="background-color: rgba(53, 143, 227, 0.040); border-radius: 25px;">
    ...
    {{-- Card kiri: Chart --}}
        <div class="col-md-7" >
            <div class="card border-0 shadow-sm p-4  h-100" style="background-color: rgba(53, 143, 227, 0.04); border-radius: 25px;">
