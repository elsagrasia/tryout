@php
    ...
    // Ambil tryout terbaru untuk tab "Semua"
                                ...
                                <div class="card h-100 shadow-sm border-0">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mt-auto d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="{{ route('user.join.tryout', $package->id) }}" class="btn theme-btn w-100">
                                                Ikuti Tryout <i class="la la-arrow-right icon ml-1"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row gx-4 gy-5">
                            ...
                            @php
                                ...
                                $catTryouts = App\Models\TryoutPackage::where('status','published')
                                    ->where('category_id', $category->id)   // sesuai kategori tryout
                                    ->orderBy('id','DESC')
                                    ->get();
                            @endphp
                            ...
                            @empty
                                <div class="col-12 text-center py-5">
                                    <img src="{{ asset('frontend/images/no-tryout.webp') }}" class="img-fluid mb-3" style="max-width: 260px;">
